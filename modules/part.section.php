...
$products_info = get_prepare_query_result($connection, $sql, $section_id);

$products_count = count($products_info);
$products_on_page = 12;
    ...
    $products_html .= /** @lang text */
        "<div class='flex littlecard'>
                ...
                <div class='flex title'>
                    <label><a href='\products.php?id=$row[product_id]'>$row[product_title]</a></label>
                    <div class='flex circle'><a href='\products.php?cat_id=$row[main_section_id]'>$row[main_section_title]</a></div>
                </div>
            </div>";
}
?>
